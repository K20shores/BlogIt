...
set shortmess=aoO
badd +1 login/templates/login/index.html
badd +8 login/views.py
badd +5 static/styles.css
badd +2 login/urls.py
badd +1 home/templates/home/index.html
badd +1 home/urls.py
badd +1 home/views.py
badd +23 blogit/urls.py
badd +1 blog/models.py
badd +1 blog/views.py
badd +1 blog/urls.py
badd +3 blog/template/blog/index.html
badd +1 blog/templates/blog/index.html
badd +0 static/css/styles.css
badd +0 static/js/main.js
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 46 - ((25 * winheight(0) + 13) / 27)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((1 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((40 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((20 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
