...
silent only
cd ~/Projects/FrogSlayer/BlogIt
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 login/templates/login/index.html
badd +8 login/views.py
badd +6 static/styles.css
badd +0 login/urls.py
badd +0 home/templates/home/index.html
badd +0 home/urls.py
badd +0 home/views.py
badd +23 blogit/urls.py
badd +0 blog/models.py
badd +0 blog/views.py
badd +0 blog/urls.py
badd +3 blog/template/blog/index.html
badd +0 blog/templates/blog/index.html
argglobal
silent! argdel *
$argadd login/templates/login/index.html
set stal=2
edit login/templates/login/index.html
...
exe '4resize ' . ((&lines * 27 + 29) / 58)
exe 'vert 4resize ' . ((&columns * 118 + 118) / 236)
tabedit home/templates/home/index.html
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((23 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 24 - ((23 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
wincmd w
argglobal
edit blog/templates/blog/index.html
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
